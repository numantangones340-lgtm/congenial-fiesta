...
class ExportAndDeviceViewTests(unittest.TestCase):
    ...
    def test_refresh_recent_exports_shows_newest_six_audio_files(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            expected = ["Cikis klasoru: ~/Demo ('Klasoru Ac' ile acabilirsiniz)", "Toplam ses: 7 | Gorunen: son 6 ses dosyasi | Siralama: yeni -> eski"]
            ...
            expected.append("- ... Ek dosyalar: 1 ses dosyasi (Tum ses dosyalari: 'Klasoru Ac')")
    ...
    def test_refresh_recent_exports_pluralizes_hidden_audio_line(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            expected = [
                ...
                "Toplam ses: 8 | Gorunen: son 6 ses dosyasi | Siralama: yeni -> eski",
                f"- {recent[0].name} (En yeni export dosyasi; 'Son Dosyayi Finder'da Goster')",
            ]
            expected.extend(f"- {path.name}" for path in recent[1:])
            expected.append("- ... Ek dosyalar: 2 ses dosyasi (Tum ses dosyalari: 'Klasoru Ac')")
    ...
    def test_refresh_recent_exports_includes_session_summary_hint(self) -> None:
        ...
        self.assertIn("Toplam ses: 1 | Gorunen: 1 ses dosyasi", recorder.recent_exports_text.get())
        self.assertIn(
            "- take_001.wav (En yeni export dosyasi; 'Son Dosyayi Finder'da Goster')",
            recorder.recent_exports_text.get(),
        )
        self.assertIn(
            "- session_summary.json (En yeni ozet dosyasi; 'Son Oturum Ozetini Ac')",
            recorder.recent_exports_text.get(),
        )
    ...
    def test_refresh_recent_exports_marks_all_audio_listed_when_multiple_files_fit(self) -> None:
        ...
        self.assertIn(
            "Toplam ses: 2 | Gorunen: tum ses dosyalari | Siralama: yeni -> eski",
            recorder.recent_exports_text.get(),
        )
    ...
    def test_refresh_recent_exports_explains_summary_when_audio_missing(self) -> None:
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    "Cikis klasoru: ~/Demo ('Klasoru Ac' ile acabilirsiniz)",
                    "Toplam ses: 0 | Gorunen: yok | En yeni ozet dosyasi hazir",
                    "Ses dosyasi yok. Asagidaki ozet dosyasini acabilirsiniz.",
                    "- session_summary.json (En yeni ozet dosyasi; 'Son Oturum Ozetini Ac')",
                ]
            ),
        )
    ...
    def test_refresh_recent_exports_from_action_reports_audio_count_with_summary(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Son ciktilar yenilendi. 1 ses dosyasi bulundu. Gorunen: 1 ses dosyasi. En yeni ozet dosyasi hazir; 'Son Oturum Ozetini Ac' ile acabilirsiniz.",
        )
    ...
    def test_refresh_recent_exports_from_action_reports_truncated_audio_list(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Son ciktilar yenilendi. 7 ses dosyasi bulundu. Gorunen: son 6 ses dosyasi. Siralama: yeni -> eski.",
        )
    ...
    def test_refresh_recent_exports_from_action_reports_summary_only_state(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Son ciktilar yenilendi. Gorunen: yok. En yeni ozet dosyasi hazir; 'Son Oturum Ozetini Ac' ile acabilirsiniz.",
        )
