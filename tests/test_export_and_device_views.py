    ...
    def test_share_detail_summary_reports_cover_name_and_package_time(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(
                ...
                "Ses türü: mp3 | Kapak dosyası: yok | Kapak türü: yok | Paket durumu: henüz yok | Son paket zamanı: henüz yok | Paket boyutu: henüz yok | ZIP boyutu: henüz yok | ZIP durumu: henüz yok | Son ZIP zamanı: henüz yok | Paket içeriği: henüz yok | Eksik paket öğeleri: yok | Hazırlık durumu: suruyor",
            )
