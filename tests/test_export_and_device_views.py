...
class ExportAndDeviceViewTests(unittest.TestCase):
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    "Klasor ~/Demo",
                    "Top 0 | Ozet",
                    "Henuz ses dosyasi yok. Alttaki ozeti acin.",
                    "- session_summary.json (Ozet)",
                ]
            ),
        )
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    "Klasor ~/Demo",
                    "Top 0",
                    "Henuz ses dosyasi yok. Yeni kayitlar burada gorunur.",
                ]
            ),
        )
    ...
    def test_refresh_recent_exports_from_action_reports_audio_count_with_summary(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Guncel. 1 ses dosyasi. Gr 1. Ozet acmaya hazir.",
        )
    ...
    def test_refresh_recent_exports_from_action_reports_empty_state_hint(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Guncel. Yeni kayitlar burada gorunur.",
        )
