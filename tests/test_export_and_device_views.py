...
class ExportAndDeviceViewTests(unittest.TestCase):
    ...
    def test_refresh_recent_exports_shows_newest_six_audio_files(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            expected = ["Cikis klasoru: ~/Demo ('Klasoru Ac')", "Toplam: 7 ses dosyasi | Gorunen: son 6 | Siralama: yeni-eski"]
            ...
            expected.append("- ... Ek: 1 ses dosyasi ('Klasoru Ac')")
    ...
    def test_refresh_recent_exports_pluralizes_hidden_audio_line(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            expected = [
                ...
                "Toplam: 8 ses dosyasi | Gorunen: son 6 | Siralama: yeni-eski",
                f"- {recent[0].name} (En yeni export; 'Son Dosyayi Finder'da Goster')",
            ]
            expected.extend(f"- {path.name}" for path in recent[1:])
            expected.append("- ... Ek: 2 ses dosyasi ('Klasoru Ac')")
    ...
    def test_refresh_recent_exports_includes_session_summary_hint(self) -> None:
        ...
        self.assertIn("Toplam: 1 ses dosyasi | Gorunen: 1", recorder.recent_exports_text.get())
        self.assertIn(
    ...
    def test_refresh_recent_exports_from_action_reports_audio_count_with_summary(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Son ciktilar yenilendi. 1 ses dosyasi bulundu. Gorunen: 1. En yeni ozet hazir; 'Son Oturum Ozetini Ac' ile acabilirsiniz.",
        )
    ...
    def test_refresh_recent_exports_from_action_reports_truncated_audio_list(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Son ciktilar yenilendi. 7 ses dosyasi bulundu. Gorunen: son 6. Siralama: yeni-eski.",
        )
    ...
    def test_refresh_recent_exports_from_action_reports_summary_only_state(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Son ciktilar yenilendi. Gorunen: bos. En yeni ozet hazir; 'Son Oturum Ozetini Ac' ile acabilirsiniz.",
        )
