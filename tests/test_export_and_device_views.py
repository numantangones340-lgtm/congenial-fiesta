...
class ExportAndDeviceViewTests(unittest.TestCase):
    ...
    def test_refresh_recent_exports_shows_newest_six_audio_files(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            expected.append("- ... Listede yok: 1 ses dosyasi (Tum ses dosyalari icin: 'Klasoru Ac')")
    ...
    def test_refresh_recent_exports_pluralizes_hidden_audio_line(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            expected.extend(f"- {path.name}" for path in recent[1:])
            expected.append("- ... Listede yok: 2 ses dosyasi (Tum ses dosyalari icin: 'Klasoru Ac')")
    ...
    def test_refresh_recent_exports_explains_summary_when_audio_missing(self) -> None:
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    "Cikis klasoru: ~/Demo ('Klasoru Ac' ile acabilirsiniz)",
                    "Ses dosyasi sayisi: 0 | Listede yok: 0 ses dosyasi | Yalnizca en yeni oturum ozeti dosyasi hazir",
    ...
    def test_refresh_recent_exports_from_action_reports_audio_count_with_summary(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Son ciktilar yenilendi. 1 ses dosyasi bulundu. Listede: 1 ses dosyasi. En yeni oturum ozeti dosyasi da hazir; 'Son Oturum Ozetini Ac' ile acabilirsiniz.",
        )
    ...
    def test_refresh_recent_exports_from_action_reports_summary_only_state(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Son ciktilar yenilendi. Listede yok: 0 ses dosyasi. Yalnizca en yeni oturum ozeti dosyasi hazir; 'Son Oturum Ozetini Ac' ile acabilirsiniz.",
        )
