...
class ExportAndDeviceViewTests(unittest.TestCase):
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    "Klasor ~/Demo",
                    "Top 0 | Ozet",
                    "Ses kaydi henuz yok. Asagidaki oturum ozetini goruntuleyebilirsiniz.",
                    "- session_summary.json (Ozet)",
                ]
            ),
        )
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    "Klasor ~/Demo",
                    "Top 0",
                    "Ses kaydi henuz yok. Yeni kayitlar burada belirecek.",
                ]
            ),
        )
    ...
    def test_refresh_recent_exports_from_action_reports_audio_count_with_summary(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Durum guncel. 1 ses dosyasi. Gr 1. Ozet hazir. Goruntuleyebilirsiniz.",
        )
    ...
    def test_refresh_recent_exports_from_action_reports_empty_state_hint(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Durum guncel. Yeni kayitlar burada belirecek.",
        )
    ...
    def test_refresh_recent_exports_from_action_reports_summary_only_state(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Durum guncel. Ozet hazir. Goruntuleyebilirsiniz.",
        )
