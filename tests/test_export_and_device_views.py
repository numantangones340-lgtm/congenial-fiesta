...
class ExportAndDeviceViewTests(unittest.TestCase):
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    "Klasor ~/Demo",
                    "Top 0 | Ozet",
                    "Henuz ses kaydi bulunmuyor. Asagidaki ozeti acabilirsiniz.",
                    "- session_summary.json (Ozet)",
                ]
            ),
        )
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    "Klasor ~/Demo",
                    "Top 0",
                    "Henuz ses kaydi bulunmuyor. Yeni kayitlar burada belirecek.",
                ]
            ),
        )
    ...
    def test_refresh_recent_exports_from_action_reports_audio_count_with_summary(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Durum guncel. 1 ses dosyasi. Gr 1. Ozet hazir. Acabilirsiniz.",
        )
    ...
    def test_refresh_recent_exports_from_action_reports_summary_only_state(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Durum guncel. Ozet hazir. Acabilirsiniz.",
        )
