...
class ExportAndDeviceViewTests(unittest.TestCase):
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    "Klasor ~/Demo",
                    "Top 0 | Ozet",
                    "Henuz ses kaydi bulunmuyor. Alttaki ozeti acabilirsiniz.",
                    "- session_summary.json (Ozet)",
                ]
            ),
        )
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    "Klasor ~/Demo",
                    "Top 0",
                    "Henuz ses kaydi bulunmuyor. Yeni kayitlar burada gorunur.",
                ]
            ),
        )
    ...
    def test_refresh_recent_exports_from_action_reports_empty_state_hint(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Durum guncel. Yeni kayitlar burada gorunur.",
        )
