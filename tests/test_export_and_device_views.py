...
class ExportAndDeviceViewTests(unittest.TestCase):
    ...
    def test_refresh_recent_exports_shows_newest_six_audio_files(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            expected = ["Cikis klasoru: ~/Demo ('Klasoru Ac' ile erisilebilir)", "Ses dosyalari: 7 | Listede: son 6 ses dosyasi | En yeni kayit ustte"]
            ...
            expected.append("- ... 1 ses dosyasi daha var (Bu listede yer almiyor, 'Klasoru Ac' ile tum ses dosyalarini gor)")
    ...
    def test_refresh_recent_exports_pluralizes_hidden_audio_line(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            expected.extend(f"- {path.name}" for path in recent[1:])
            expected.append("- ... 2 ses dosyasi daha var (Bu listede yer almiyorlar, 'Klasoru Ac' ile tum ses dosyalarini gor)")
