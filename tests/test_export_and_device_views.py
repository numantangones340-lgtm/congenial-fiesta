...
class ExportAndDeviceViewTests(unittest.TestCase):
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    "Klasor ~/Demo",
                    "Toplam 0 | Gr 0",
                    "Henuz export yok. Yeni kayitlardan sonra burada gorunecek.",
                ]
            ),
        )
    ...
    def test_refresh_recent_exports_from_action_reports_audio_count_with_summary(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Liste yenilendi. 1 ses dosyasi. Gr 1. Ozet; 'Son Oturum Ozetini Ac'.",
        )
    ...
    def test_refresh_recent_exports_from_action_reports_empty_state_hint(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Liste yenilendi. Gr 0. Yeni kayitlardan sonra burada gorunecek.",
        )
