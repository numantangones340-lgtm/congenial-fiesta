...
class ExportAndDeviceViewTests(unittest.TestCase):
    ...
    def test_refresh_recent_exports_shows_newest_six_audio_files(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            expected = ["Cikis klasoru: ~/Demo ('Klasoru Ac' ile acabilirsiniz)", "Ses dosyalari: 7 | Listede: son 6 ses dosyasi | En yeni kayit ustte"]
            ...
            expected.append("- ... 1 ses dosyasi daha var (Bu listede yer almiyor, 'Klasoru Ac' ile tum ses dosyalarini gorebilirsiniz)")
    ...
    def test_refresh_recent_exports_pluralizes_hidden_audio_line(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            expected = [
                ...
                "Ses dosyalari: 8 | Listede: son 6 ses dosyasi | En yeni kayit ustte",
    ...
    def test_refresh_recent_exports_marks_all_audio_listed_when_multiple_files_fit(self) -> None:
        ...
        self.assertIn(
            "Ses dosyalari: 2 | Tum ses dosyalari listede | En yeni kayit ustte",
            recorder.recent_exports_text.get(),
        )
    ...
    def test_refresh_recent_exports_explains_summary_when_audio_missing(self) -> None:
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    "Cikis klasoru: ~/Demo ('Klasoru Ac' ile acabilirsiniz)",
                    "Ses dosyalari: 0 | Ses dosyasi listesi bos | Yalnizca son oturum ozeti dosyasi hazir",
    ...
    def test_refresh_recent_exports_clears_stale_summary_from_other_folder(self) -> None:
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    "Cikis klasoru: ~/Demo ('Klasoru Ac' ile acabilirsiniz)",
                    "Ses dosyalari: 0 | Ses dosyasi listesi bos",
    ...
    def test_refresh_recent_exports_from_action_reports_truncated_audio_list(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Son ciktilar yenilendi. 7 ses dosyasi bulundu. Listede: son 6 ses dosyasi. En yeni kayit ustte.",
        )
    ...
    def test_refresh_recent_exports_from_action_reports_empty_state_hint(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Son ciktilar yenilendi. Ses dosyasi listesi bos. Yeni kayitlardan sonra ciktilar burada gorunecek.",
        )
    ...
    def test_refresh_recent_exports_from_action_reports_summary_only_state(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Son ciktilar yenilendi. Ses dosyasi listesi bos. Yalnizca son oturum ozeti dosyasi hazir; 'Son Oturum Ozetini Ac' ile acabilirsiniz.",
        )
