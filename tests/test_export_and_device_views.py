...
class ExportAndDeviceViewTests(unittest.TestCase):
    ...
    def test_refresh_recent_exports_shows_newest_six_audio_files(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            expected = ["Klasor: ~/Demo (Klasoru Ac ile erisilebilir)", "Ses dosyalari: 7 | Gosterilen: 6 (Son 6 kayit) | En yeni ustte"]
            ...
            expected.append("- ... 1 ses dosyasi daha var (Klasoru Ac ile tumunu gor)")
    ...
    def test_refresh_recent_exports_includes_session_summary_hint(self) -> None:
        ...
        self.assertIn("Ses dosyalari: 1 | Gosterilen: 1 | Tek kayit listede", recorder.recent_exports_text.get())
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    ...
                    "Ses dosyalari: 0 | Gosterilen: 0 | Ses listesi bos | Yalnizca ozet var",
    ...
    def test_refresh_recent_exports_from_action_reports_summary_only_state(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Son ciktilar yenilendi. Ses listesi bos, yalnizca son oturum ozeti var ve acilabilir.",
        )
