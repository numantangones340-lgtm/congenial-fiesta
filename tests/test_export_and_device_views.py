...
class ExportAndDeviceViewTests(unittest.TestCase):
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    "Klasor ~/Demo",
                    "Top 0 | Ozet",
                    "Ses dosyasi yok. Alttaki ozeti acabilirsiniz.",
                    "- session_summary.json (Ozet)",
                ]
            ),
        )
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    "Klasor ~/Demo",
                    "Top 0",
                    "Ses dosyasi yok. Yeni kayitlar burada yer alir.",
                ]
            ),
        )
    ...
    def test_refresh_recent_exports_from_action_reports_audio_count_with_summary(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Guncel. 1 ses dosyasi. Gr 1. Ozet acilabilir.",
        )
    ...
    def test_refresh_recent_exports_from_action_reports_empty_state_hint(self) -> None:
        ...
        self.assertEqual(
            recorder.status_messages[-1],
            "Guncel. Yeni kayitlar burada yer alir.",
        )
