...
class GuitarAmpRecorderApp:
    ...
    def recent_output_open_status_status_text(self, prefix: str, path: Path) -> str:
        return f"{self.recent_output_open_status_status_prefix(prefix)}: {self.recent_output_open_status_detail_text(path)}"
    ...
    def output_dir_open_status_status_text(self, output_dir: Path, created_now: bool) -> str:
        return self.output_dir_open_status_text(output_dir, created_now)
