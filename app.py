...
class GuitarAmpRecorderApp:
    def __init__(self, root: Tk) -> None:
        ...
        self.copy_quick_favorites_path_button = Button(
            preset_row,
            text="Favori Yolunu Kopyala",
            command=self.copy_quick_favorites_summary_path_to_clipboard,
            bg="#475569",
            fg="white",
        )
        ...
        self.copy_quick_favorites_name_button = Button(
            preset_row,
            text="Favori Adını Kopyala",
            command=self.copy_quick_favorites_summary_name_to_clipboard,
            bg="#64748b",
            fg="white",
        )
        ...
        self.copy_last_export_name_button = Button(
            recent_copy_buttons,
            text="Dosya Adını Kopyala",
            command=self.copy_last_export_name_to_clipboard,
            bg="#475569",
            fg="white",
            state="disabled",
        )
        ...
        self.layout_button_flow(
            ...
            [
                ...
                self.copy_last_export_name_button,
        ...
        for button, role in (
            ...
            (self.copy_last_export_name_button, "secondary"),
    ...
    def copy_quick_favorites_summary_path_to_clipboard(self) -> None:
        ...
        self.copy_text_to_clipboard(
            str(summary_path),
            self.copied_item_status("Favori özeti yolu", summary_path.name),
            "Favori özeti yolu kopyalanamadı",
        )

    def copy_quick_favorites_summary_name_to_clipboard(self) -> None:
        summary_path = self.quick_favorites_summary_path()
        if summary_path is None or not summary_path.exists():
            self.set_status("Favori özeti dosyası yok.")
            return
    ...
    def copy_last_export_name_to_clipboard(self) -> None:
        if self.last_export_path is None or not self.last_export_path.exists():
            self.set_status(self.missing_item_status("Son kayıt"))
            return
        self.copy_text_to_clipboard(
            self.last_export_path.name,
            self.copied_item_status("Dosya adı", self.last_export_path.name),
            "Dosya adı kopyalanamadı",
        )
    ...
    def finish_recording_progress(self, final_text: str = "Kayıt durumu: beklemede") -> None:
        ...
        try:
            ...
            if self.last_export_path is not None and self.last_export_path.exists():
                ...
                self.copy_last_export_name_button.configure(state="normal")
            else:
                ...
                self.copy_last_export_name_button.configure(state="disabled")
            if self.last_summary_path is not None and self.last_summary_path.exists():
